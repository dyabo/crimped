...
_RU: dict[str, str] = {
    ...
    "Load ramp": "Скачок нагр.", "Monotony": "Монотонность", "Strain": "Стрейн",
    "EWMA load": "EWMA нагр.", "Δ load %": "Δ нагр. %",
    ...
    "Load ramp vs 4-week average": "Скачок нагрузки к 4-нед. среднему",
    "Monotony (day-to-day sameness)": "Монотонность (однообразие по дням)",
    "Strain (load × monotony)": "Стрейн (нагрузка × монотонность)",
    "Lines appear as Week fills in. Axes are pre-scaled to your plan's range. The load ramp and monotony describe what changed — they are not injury predictions; see the Glossary.":
        "Линии появляются по мере заполнения «Недели». Оси подогнаны под диапазон плана. Скачок нагрузки и монотонность описывают, что изменилось, — это не предсказание травм; см. «Глоссарий».",
    ...
    "Load ramp (vs 4-wk avg)": "Скачок нагрузки (к 4-нед. средн.)",
    "~1.0 steady · high = ramped fast (not a risk score)":
        "~1.0 ровно · высоко = резко прибавил (это не оценка риска)",
    ">2 = every day alike; pair with load": ">2 = все дни одинаковы; смотри вместе с нагрузкой",
